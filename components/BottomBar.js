...
function AddNew({ OpenModal, AdditionalText }) {
    return (
...
export function BottomBar({ OpenAddScheme, OpenAddMedicine }) {
    return (
        <View style={tw.style`flex flex-row gap-4 items-start justify-center m-4`}>
            <View style={tw.style`w-8 flex flex-col gap-2 items-center justify-center`}>
                <IconButton Icon={"setting"}/>
                <IconButton Icon={"medicinebox"}/>
            </View>
            <View style={tw.style`flex flex-col gap-2 items-start justify-center`}>
                <AddNew OpenModal={OpenAddScheme} AdditionalText={"Scheme"} />
                <AddNew OpenModal={OpenAddMedicine} AdditionalText={"Medicine"} />
            </View>
        </View>
